...
Unified discovery is governed by [object taxonomy `PHAOS-OBJECT-TAXONOMY-001`](docs/UNIFIED-REGISTRY-TAXONOMY.md) and [identity policy `PHAOS-IDENTITY-001`](docs/IDENTITY-LIFECYCLE-POLICY.md). The generated identity baseline reconciles 4,743 canonical objects, 4,797 source-layer representations and 560 report-column occurrences while representing the 54 shared registry/HMIS indicators only once canonically. This is a metadata and identity layer, not a dataset of observed health values.

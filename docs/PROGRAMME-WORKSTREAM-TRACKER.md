...
3. **UNIFY-01–UNIFY-10 — Unified registry — In progress.** UNIFY-01 object taxonomy, UNIFY-02 persistent identity and UNIFY-03 programme-versus-system filtering are complete. Next build the single discovery interface and consolidated read model under UNIFY-04/05.

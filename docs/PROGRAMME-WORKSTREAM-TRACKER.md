...
3. **UNIFY-01–UNIFY-10 — Unified registry — In progress.** UNIFY-01 object taxonomy, UNIFY-02 persistent identity, UNIFY-03 programme-versus-system filtering, UNIFY-04 single discovery interface and UNIFY-05 consolidated read model are complete. Next expose report fields as first-class occurrence records under UNIFY-06.

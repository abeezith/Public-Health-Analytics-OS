...
Release 3.1 adds an Immunization knowledge-graph proof of concept generated from the canonical registry. It represents all 76 programme-discoverable indicators and 102 linked HMIS identities, five curated source-neutral concepts, typed and evidence-qualified relationships, normalized six-building-block and reporting-level vocabularies, a machine-readable graph contract, Schema.org/JSON-LD publication metadata and automated graph-integrity QA. Seven HMIS-derived indicators retain a single stable identity while carrying both registry and HMIS types.

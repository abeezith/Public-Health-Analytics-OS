...
UNIFY-01 and UNIFY-02 establish the governed foundation for a single discovery interface. [`PHAOS-OBJECT-TAXONOMY-001`](../docs/UNIFIED-REGISTRY-TAXONOMY.md) distinguishes indicators, data elements, outputs, validation rules and report occurrences; [`PHAOS-IDENTITY-001`](../docs/IDENTITY-LIFECYCLE-POLICY.md) reconciles 4,743 canonical objects and 4,797 source representations while deduplicating the 54 shared registry/HMIS indicators. The generated identity index also records 560 report-column occurrences separately from canonical definitions.
